...
MIconItem::MIconItem(QQuickItem *parent)
...
void MIconItem::setSource(const QVariant &source)
{
    if (source == m_source) {
        return;
    }
...
void MIconItem::paint(QPainter *painter)
{
...
void MIconItem::updateIcon()
{
    loadPixmap();
}

void MIconItem::loadPixmap()
{
...
void MIconItem::geometryChange(const QRectF &newGeometry, const QRectF &oldGeometry)
{
